...
function MainPage() {
    ...
    return (
        <div className="flex w-full min-w-150 flex-col items-start gap-6">
            <div className="flex w-full flex-row items-center gap-4.5 px-2.625 py-1">
            ...
            <div className="flex w-full flex-col items-start gap-0.5 px-7.5">
            ...
            <div className="flex w-full flex-col items-start gap-6.25 px-7.5">
