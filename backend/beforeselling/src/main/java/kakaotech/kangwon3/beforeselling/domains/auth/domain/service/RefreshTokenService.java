...
public class RefreshTokenService {
    ...
    public void saveRefreshToken(String jti, UUID userId, Duration ttl) {
     ...
     */
    public void consumeRefreshToken(String jti, UUID userId) {
        UUID storedUserId = refreshTokenRepository.getAndDeleteUserIdByJti(jti)
